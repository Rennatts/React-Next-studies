...
Notes in this folder focus on the **Next.js App Router**: **file-based routing**, server-side data and RSC behavior, Suspense/streaming, and how that differs from generic client-only React.

## Topics

| Topic | Folder | Route |
|-------|--------|--------|
| File-based routing | [`file-based-routing`](./file-based-routing/README.md) | `/studies/next-server/file-based-routing` |
| Layouts and nested layouts | [`layouts-and-nested-layouts`](./layouts-and-nested-layouts/README.md) | `/studies/next-server/layouts-and-nested-layouts` |
